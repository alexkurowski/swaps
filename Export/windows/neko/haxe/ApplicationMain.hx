...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("MapiSoft", "Swaps", "com.mapisoft.swaps", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Swaps", null, { width: 375, height: 640 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 375, height: 640 });
			#end
